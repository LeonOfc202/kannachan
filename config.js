...
global.owner = [
  ...
  ['6287752078797', 'Owner Gweh', true] //Ganti jd nomormu sama Namamu
...
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Nana-Chan ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Leon-Chan '
global.botdate = `⫹⫺ 𝗗𝗮𝘁𝗲: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By LeonOfc`
global.author = '                「 Nana - Chan  あ⁩ 」'
...
/*============== STICKER WM ==============*/
global.stickpack = 'Nana-Chan'
global.stickauth = `By ©LeonOfc`
